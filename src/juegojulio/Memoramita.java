...
public class Memoramita extends javax.swing.JFrame {
    ...
    private ComoJugar mano = new ComoJugar();
    private boolean voltealas = false;
    private ImageIcon imag1;
    private ImageIcon imag2;
    private JButton[] reiniciar = new JButton[2];
    ...
    public Memoramita() {
        ...
        pro = new Caratula(getWidth(), getHeight());
        add(pro, BorderLayout.CENTER);
        setCards();
    }       
    
    private void setCards() {
        int[] numbers = mano.getCardNumbers();
        
        btnC1.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[0]+".png")));
        btnC2.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[1]+".png")));
        btnC3.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[2]+".png")));
        btnC4.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[3]+".png")));
        btnC5.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[4]+".png")));
        btnC6.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[5]+".png")));
        btnC7.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[6]+".png")));
        btnC8.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[7]+".png")));
        btnC9.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[8]+".png")));
        btnC10.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[9]+".png")));
        btnC11.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[10]+".png")));
        btnC12.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[11]+".png")));
        btnC13.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[12]+".png")));
        btnC14.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[13]+".png")));
        btnC15.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[14]+".png")));
        btnC16.setDisabledIcon(new ImageIcon(getClass().getResource("../baraja/d"+numbers[15]+".png")));
    }    
    ...
    private void compare() {
        if(voltealas && carta) {
            ...
            if(imag1.getDescription().compareTo(imag2.getDescription()) != 0) {
                reiniciar[0].setEnabled(true);
                reiniciar[1].setEnabled(true);
    ...
    private void pregwin() {
        if(!btnC1.isEnabled() && !btnC2.isEnabled() && !btnC3.isEnabled() && !btnC4.isEnabled() && !btnC5.isEnabled() && !btnC6.isEnabled() && 
            ...
            JOptionPane.showMessageDialog(this, "Eres todo un campeon,estoy orgulloso de ti!!, Su puntuacion es: "+score, "sigue asi!!", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        btnC1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnC13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/baraja/d0.png"))); // NOI18N
        ...
        btnReiniciar.setFont(new java.awt.Font("Wide Latin", 2, 18)); // NOI18N
        btnReiniciar.setForeground(new java.awt.Color(0, 153, 153));
        btnReiniciar.setText("vuelve a intentarlo");
        ...
        setSize(new java.awt.Dimension(647, 677));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Memoramita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Memoramita().setVisible(true);
            }
        });
    }
